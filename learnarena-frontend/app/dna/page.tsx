  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 mb-6 text-center">
        ...
        {/* Rank badge */}
        <div className={`inline-flex items-center gap-2 px-5 py-2 rounded-full border text-lg font-black ${rankStyle.bg} ${rankStyle.text} ${rankStyle.border} mb-4`}>
                ...
                <div key={subject}>
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-xs text-slate-400">
                      {stat.correct}/{stat.attempted} · {accuracy.toFixed(1)}%
                    </span>
                  </div>
